                ...
                <Pod.FixedElement key={'fixednavigation'} styler={{ style: { top: 0, left: 0, width: '100%' } }}>
                    <Pod.Toolbar>
                        <Pod.ContentWrap>
                            ...
                            <Pod.Menu orientation="horizontal">
                                <Pod.Menu_Item>Home</Pod.Menu_Item>
                                <Pod.Menu_Item>About</Pod.Menu_Item>
                                <Pod.Menu_Item>Contact</Pod.Menu_Item>

                                <Pod.Menu
                                    trigger={
                                        <Pod.Button styler={{ kind: 'general' }} label="On Hover" />
                                    }
                                >
                                    <Pod.Menu_Item>Contact</Pod.Menu_Item>
                                </Pod.Menu>
                ...
                <Pod.Section>
                    <Pod.ContentWrap styler={{ style:{ textAlign: 'center' } }}>
                        ...
                        <Pod.Card styler={{ padded:true, style:{ width: '350px', textAlign: 'center' } }} title="Don't forget to sign up to our Email">
                            ...
                            <Pod.Input placeholder="Your Email" type="email" validate />
                            <Pod.Paragraph>Lorem ipsum dolor sit amet, consectetur adipisicing elit.</Pod.Paragraph>
                        </Pod.Card>
                    </Pod.ContentWrap>
                </Pod.Section>
                ...
                <Pod.Section styler={{ style: { backgroundColor: '#000', padding: '0px', border: 'none' } }}>
                    <Pod.Parallax background={(<div style={{ width:'100%', height: '100%', backgroundImage: 'url(assets/media/bg2.jpg)', backgroundSize: 'cover', backgroundPosition:'center center', opacity: '0.8' }}></div>)}>
                        <Pod.Center styler={{ style: { color: 'white' } }}>
                            ...
                            <Pod.Device trueScaling variant="gold" device="macbook" styler={{ style: { display: 'inline-block' } }}>
                                <Pod.Embed width="100%" height="100%" src="http://themehouse.com" />
                            </Pod.Device>
                        </Pod.Center>
                    </Pod.Parallax>
