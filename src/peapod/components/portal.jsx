...
export default class Portal extends React.Component {
	...
	componentDidUpdate(prevProps, prevState) {
		//console.log(ReactDOM.findDOMNode(this.trigger));
	...
	render() {
		if (this.props.trigger) {
			return <div className="trigger" onClick={this.openPortal.bind(this, this.props)} onMouseEnter={this.openPortal.bind(this, this.props)}>{this.props.trigger}</div>;
		} else {
