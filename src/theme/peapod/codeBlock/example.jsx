...
`<Pod.ContentWrap>
    ...
    <Pod.CodeBlock label="Javascript">{codeExample__javascript}</Pod.CodeBlock>
    <Pod.CodeBlock label>{codeExample__html}</Pod.CodeBlock>
    <Pod.CodeBlock label>{codeExample__css}</Pod.CodeBlock>
    <Pod.CodeBlock label>{codeExample__cpp}</Pod.CodeBlock>
    <Pod.CodeBlock label>{codeExample__python}</Pod.CodeBlock>
    ...
    render() {
        return (
            <Pod.ContentWrap>
                ...
                <Pod.CodeBlock label>{codeExample__javascript}</Pod.CodeBlock>
                <Pod.CodeBlock label="JSX markup">{codeExample__jsx}</Pod.CodeBlock>
                <Pod.CodeBlock label>{codeExample__css}</Pod.CodeBlock>
                <Pod.CodeBlock label>{codeExample__cpp}</Pod.CodeBlock>
                <Pod.CodeBlock label>{codeExample__python}</Pod.CodeBlock>
